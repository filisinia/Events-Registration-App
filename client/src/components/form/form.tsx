  ...
  return (
    <Dialog open={!!eventData} onClose={closeDialog}>
      <Box component="form" onSubmit={handleSubmit} noValidate sx={styles.form}>
        ...
        <TextField aria-labelledby="dateOfBirth" name="dateOfBirth" type="date" size="small" required fullWidth />
        <FormLabel id="howDidYouHear">Where did you hear about this event?</FormLabel>
        <RadioGroup aria-labelledby="howDidYouHear" defaultValue="social media" name="howDidYouHear" row>
        ...
        <Box>
          <Button onClick={closeDialog} variant="outlined" sx={{ marginRight: '15px' }}>
            Back
          </Button>
